...
市面上的专注软件（如 Forest）通常只记录“时间投入”，且只有简单的标签分类。而我们认为，效率不仅包含**时间的投入**，更包含**阶段性的产出**。

受到挂机游戏《Melvor Idle（梅尔沃放置）》的启发，我们将游戏化的数值体系引入到项目管理中。在这里，你不仅是在“种树”，更是在经营你的知识森林——你就是“密涅瓦的巡林官”！
...
[ ] 成就系统：解锁“拉文克劳院长”、“密涅瓦的猫头鹰”等趣味成就。

## 📥 下载与体验
目前 **密涅瓦的巡林官** 已发布在 Itch.io 平台，支持 macOS 系统，后续也会支持 windows 系统。

- **Itch.io**: [点击前往下载页面 (链接待补充)](#)
